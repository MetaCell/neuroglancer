...
import {TRANSFER_FUNCTION_LENGTH} from 'neuroglancer/widget/transfer_function';
        ...
        'colormap', {
          ...
          default: {
            controlPoints: [
              ...
              {position: Math.ceil(maxTransferFunctionPoints / 2), color: vec4.fromValues(255, 0, 0, 128)},
              {position: maxTransferFunctionPoints, color: vec4.fromValues(0, 255, 0, 26)},
            ],
            channel: [],
