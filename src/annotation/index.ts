...
export function addAnnotationClassToIcon(icon: HTMLElement, annotationType: AnnotationType) {
  icon.classList.remove('annotation-point', 'annotation-line', 'annotation-box', 'annotation-ellipsoid');
