...
def test_ome_zarr_0_6_sequence(static_file_server, webdriver):
    ...
    permuted_voxel = (TEST_VOXEL[0] + 8, TEST_VOXEL[1] + 7, TEST_VOXEL[2] + 5)
    _verify_data_at_point(model_space["volume"], permuted_voxel, EXPECTED_VALUE)
...
def test_ome_zarr_0_6_affine(static_file_server, webdriver):
    ...
    Origins after normalization: [8, 7, 5]
    Array index (13, 122, 169) in (z,y,x) appears at voxel (21, 129, 174).
    """
